    ...
    <Stack direction={['column', 'row']} h={'100vh'} >
      <VStack w={'full'} >
        ...
        <VStack alignItems={'flex-start'} p={'8'} overflowY={'auto'} w={'full'}>
          ...
          <Text>This a sample text for the sample video 1. This is a sample test and demo text. This is called as Description.</Text>
        </VStack>
      </VStack>

      <VStack w={['full','xl']} alignItems={'stretch'} p={'8'} spacing={'8'} overflowY={'auto'} >
      <Heading textTransform={'uppercase'} size={'md'}>Lectures</Heading>
